...
- `rag-assistant-service` (Python/FastAPI/LangGraph) — retrieve → generate → guardrail graph over `policy_documents` via MongoDB Atlas Vector Search; explains decisions and answers policy questions only.
